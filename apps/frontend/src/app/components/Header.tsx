...
// Components moved to route groups or removed
...
export function Header({
  ...
  return (
    <>
      {/* AppDrawer is now likely managed within a route group layout */}
      <header className="glass-card mx-4 mt-4 p-6 animate-slide-up md:ml-84">
        <div className="flex justify-between items-center flex-wrap gap-4">
          ...
          <div className="flex items-center gap-3">
            {/* GoogleStyleMenu is now likely managed within a route group layout */}
            {currentUser ? (
            <>
