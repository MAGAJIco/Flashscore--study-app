      ...
      {menuOpen && (
        <div className="fixed left-0 top-16 bottom-0 w-64 bg-white/10 backdrop-blur-xl border-r border-white/20 z-40 overflow-y-auto">
          <div className="p-6 space-y-2">
            <Link href="#overview" className="block px-4 py-2 rounded-lg hover:bg-white/20 text-white transition-colors">
              Overview
            </Link>
            <Link href="#features" className="block px-4 py-2 rounded-lg hover:bg-white/20 text-white transition-colors">
              Feature Apps
            </Link>
            <Link href="#architecture" className="block px-4 py-2 rounded-lg hover:bg-white/20 text-white transition-colors">
              Architecture
            </Link>
            <Link href="#api" className="block px-4 py-2 rounded-lg hover:bg-white/20 text-white transition-colors">
              API Reference
            </Link>
            <Link href="#migration" className="block px-4 py-2 rounded-lg hover:bg-white/20 text-white transition-colors">
              Migration Guide
            </Link>
          </div>
        </div>
      ...
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 transition-all ${menuOpen ? 'ml-64' : ''}`}>
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Link href="#features" className="px-6 py-3 bg-white/20 text-white rounded-lg font-semibold hover:bg-white/30 transition-colors">
              Explore Features
            </Link>
          </div>
        </div>
